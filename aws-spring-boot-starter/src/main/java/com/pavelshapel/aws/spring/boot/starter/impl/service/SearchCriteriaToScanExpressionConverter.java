...
public class SearchCriteriaToScanExpressionConverter implements ToScanExpressionConverter {
    @Override
    ...
    private Map<String, String> updateExpressionAttributeNames(Set<SearchCriterion> searchCriteria) {
        return searchCriteria.stream()
