...
class DynamoDBTransactionWriteExpressionFromSearchCriteriaConverterTest {
    ...
    void convert_WithValidParameter_ShouldReturnAppropriateDynamoDBQueryExpression(SearchOperation searchOperation) {
        SearchCriterion searchCriterion = SearchCriterion.builder()
                ...
                .build();
        String expressionAttributeName = transactionWriteExpressionFromSearchCriteriaConverter.createExpressionAttributeName(searchCriterion);
        ...
        assertThat(result)
                .hasFieldOrPropertyWithValue("conditionExpression", String.format(searchOperation.getSearchOperationPattern(), expressionAttributeName))
