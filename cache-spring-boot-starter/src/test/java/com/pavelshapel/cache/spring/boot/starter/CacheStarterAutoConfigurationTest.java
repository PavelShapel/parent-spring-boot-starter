...
class CacheStarterAutoConfigurationTest {
    ...
    void shouldLoadCacheManagerBeanIntoContext() {
        assertThat(applicationContext.containsBean("cacheManager"))
                .isTrue();
    }
    ...
    void shouldCreateSingletonCacheManagerBean() {
        ...
        assertThat(cacheManagerOne)
                .isSameAs(cacheManagerTwo);
    }

    @Test
    void shouldHaveCacheManagerBeanWithSingletonScope() {
        assertThat(applicationContext.isSingleton("cacheManager"))
                .isTrue();
    }
}
